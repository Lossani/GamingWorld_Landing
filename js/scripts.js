...
aLangKeys['en']['tips']='News and Tournaments';
aLangKeys['en']['large-text-3']='Improve your skills attending tournaments organized by the same community.';
aLangKeys['en']['video']='Video About The Product';
aLangKeys['en']['choose']='Choose your plan';
aLangKeys['en']['things']='Features: Gamer Amateur - Streamer Amateur - News and tournaments creation';
aLangKeys['en']['amount']='USD/month';
aLangKeys['en']['selected']='SELECT';
aLangKeys['en']['select-2']='SELECT';
aLangKeys['en']['things-2']='Features: All features from Free Plan - Tournament Management';
...
aLangKeys['es']['tips']='Noticias y Torneos';
aLangKeys['es']['large-text-3']='Mejora tus habilidades asistiendo a torneos organizados por la misma comunidad.';
aLangKeys['es']['video']='Video Sobre El Producto';
aLangKeys['es']['choose']='Selecciona un plan';
aLangKeys['es']['things']='Beneficios: Gamer Amateur - Streamer Amateur - Noticias y Creaciones de torneos';
...
aLangKeys['en']['team']='Video Acerca Del Equipo';
